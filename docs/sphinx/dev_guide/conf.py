# -*- coding: utf-8 -*-
#
# RAJA documentation build configuration file, created by
...
htmlhelp_basename = 'RAJAuserguide'
...
latex_documents = [
    (master_doc, 'RAJA.tex', u'RAJA User Guide',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'raja', u'RAJA User Guide',
     [author], 1)
]
